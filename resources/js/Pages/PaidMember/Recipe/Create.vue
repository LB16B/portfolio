                            ...
                            <div class="container px-5 py-8 mx-auto">
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        <!-- {{ $page.props.auth.user.id }}/{{ paid_member.id }} -->

                                        <!-- <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="paid_member_id" class="leading-7 text-sm text-gray-600">有料会員ID</label>
                                                <input v-model="props.value.auth.user.id" type="number" id="paid_member_id" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div> -->
