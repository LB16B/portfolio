            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <!-- <img alt="ecommerce" class="lg:w-24 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://dummyimage.com/400x400"> -->
                        <!-- <a class="block relative h-48 rounded overflow-hidden"> -->
                            <img :src="'/recipe_images/' + recipe.filename" class="lg:w-1/2  w-full lg:h-auto object-cover object-center rounded">
                        <!-- </a> -->
