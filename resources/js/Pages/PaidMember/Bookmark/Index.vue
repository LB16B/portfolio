...
const deleteBookmark = id => {
    Inertia.delete(route('paid_member.bookmark_destroy', { recipe_id: id }), {
                ...
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="flex flex-col text-center w-full mb-20">
                            <h1 class="text-2xl font-medium title-font mb-4 text-gray-900 tracking-widest">ブックマーク登録したレシピ一覧</h1>
                        </div>
                                        ...
                                        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                                            ...
                                            <div class="flex-grow sm:pl-8">
                                                ...
                                                <span class="inline-flex">
                                                    ...
                                                    <button @click="deleteBookmark(recipe.id)" class="mr-4">削除</button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
