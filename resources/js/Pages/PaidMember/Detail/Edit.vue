                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="number" id="paid_member_id" name="paid_member_id"
                                                           v-model="form.paid_member_id"
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input @change="fileSelected" id="file" name="file" type="file"
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="greeting"
                                                           class="leading-7 text-sm text-gray-600">挨拶</label>
                                                    <textarea id="greeting" name="greeting" v-model="form.greeting"
